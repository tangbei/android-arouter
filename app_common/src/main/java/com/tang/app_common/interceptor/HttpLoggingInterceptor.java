...
import com.tang.app_common.utils.UrlEncoderUtil;
import com.tang.app_common.utils.ZipHelper;
...
public class HttpLoggingInterceptor implements Interceptor {
    ...
    public HttpLoggingInterceptor() {
        mHandler = new GlobalHttpHandlerImpl(ConstantUtil.getAPPContext());
