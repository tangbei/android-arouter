...
#实体类不能混淆
#-keep class com.gs.toolmall.entity.** { *; } //实体类混淆，暂时还没有实体，有时则添加
#-keep class com.gs.toolmall.api.** { *; }
#-keep class com.gs.toolmall.ui.uientry.** { *; }
#-keep class com.gs.toolmall.ui.mine.myfoot.entity.** { *; }
#-keep class com.gs.toolmall.**{*;}       #不混淆某个包内的所有文件
#-keep class com.gs.toolmall.item.** { *; }

#-keep class com.gs.toolmall.utils.AppSettingUtil
...
################七鱼客服#################暂无
#-keep class com.qiyuk.** {*;}
#-dontwarn com.qiyukf.**
#-keep class **.R$* { *; }
#-keep class com.qiyukf.nimlib.sdk.** { *; }
#-keep class com.qiyukf.unicorn.api.** { *; }
#-keep class com.qiyukf.basesdk.sdk.** { *; }
...
#    public static ** valueOf(java.lang.String);
#}
#-keep public class com.gs.toolmall.R$*{
#    public static final int *;
#}
...
###############liveDataBus#################
-keep class com.tang.common.livedata.LiveDataBus
